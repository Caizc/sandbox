...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp0(byte[] p0, out int p1)
		{
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Assets.Demos.Sandbox.ProtobufDecoder.DecoderDelegate))
			{
			    return new Assets.Demos.Sandbox.ProtobufDecoder.DecoderDelegate(__Gen_Delegate_Imp0);
			}
